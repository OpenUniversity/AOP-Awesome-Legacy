...
class MethodEntryRequestImpl extends EventRequestImpl<com.sun.jdi.request.MethodEntryRequest> implements ajdi.request.MethodEntryRequest {

	public MethodEntryRequestImpl(MethodEntryRequest base, ShadowMaster master) {
		super(base, master);
	}
