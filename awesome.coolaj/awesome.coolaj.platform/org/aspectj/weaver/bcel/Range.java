...
public abstract class Range implements InstructionTargeter {
	...
	public static InstructionHandle getRealEnd(InstructionHandle ih) {
		while (Range.isRangeHandle(ih)) {
			ih = ih.getPrev();
		}
		return ih;
	...
	public InstructionHandle insert(Instruction i, Where where) {
	...
	public static final Range getRange(InstructionHandle ih) {
