...
public class MethodJoinPointEntryEventImpl extends LocatableEventImpl<MethodEntryEvent>
		implements JoinPointEntryEvent {

	private JoinPointEntryRequest jpr;

	public MethodJoinPointEntryEventImpl(MethodEntryEvent e,
			JoinPointEntryRequest jpr) {
