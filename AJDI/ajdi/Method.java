...
public interface Method extends TypeComponent, SourceLocatable, Comparable<Method>,Shadow {
	...
	/**
	 * singleton behalve bij constructoren
	 * @return
	 */
...
//    byte[] bytecodes();
    ...
    /**
     * Returns the {@link SourceLocation} of this method
     *
     * @return the {@link SourceLocation} of this mirror, or null if
