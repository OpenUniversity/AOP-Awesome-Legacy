...
public interface EventRequestManager extends Mirror {
	...
	JoinPointEntryRequest createJoinPointEntryRequest(JoinPoint jp);
	List<JoinPointEntryRequest> joinPointEntryRequests();
	
	JoinPointExitRequest createJoinPointExitRequest(JoinPoint jp);
	List<JoinPointExitRequest> joinPointExitRequests();
  ...
  /*  *//**
    ...
    *//**
	...
	AspectAdditionRequest createAspectAdditionRequest();
	List<AspectAdditionRequest> getAspectAdditionRequests();
	
	AspectRemovalRequest createAspectRemovalRequest();
	List<AspectAdditionRequest> getAspectRemovalRequests();
	
	AdviceAdditionRequest createAdviceAdditionRequest();
	List<AdviceAdditionRequest> getAdviceAdditionRequests();
	
	AdviceRemovalRequest createAdviceRemovalRequest();
	List<AdviceAdditionRequest> getAdviceRemovalRequests();
	BindingAdditionRequest createBindingAdditionRequest();
	List<BindingAdditionRequest> getBindingAdditionRequests();
	BindingRemovalRequest createBindingRemovalRequest();
	List<BindingRemovalRequest> getBindingRemovalRequests();
	
	AdviceApplicationRequest createAdviceApplicationRequest(AdviceApplication aapl);
	List<AdviceApplicationRequest> getAdviceApplicationRequests();
}
