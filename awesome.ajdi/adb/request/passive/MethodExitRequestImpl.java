...
class MethodExitRequestImpl extends EventRequestImpl< com.sun.jdi.request.MethodExitRequest> implements ajdi.request.MethodExitRequest {

	public MethodExitRequestImpl(MethodExitRequest base, ShadowMaster master) {
		super(base, master);
	}
