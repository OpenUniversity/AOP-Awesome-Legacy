...
abstract class WatchpointRequestImpl<T extends com.sun.jdi.request.WatchpointRequest> extends EventRequestImpl<T>implements ajdi.request.WatchpointRequest {

	public WatchpointRequestImpl(T base, ShadowMaster master) {
		super(base, master);
	}
