...
class ClassUnloadRequestImpl extends EventRequestImpl<com.sun.jdi.request.ClassUnloadRequest> implements ajdi.request.ClassUnloadRequest {
	
	public ClassUnloadRequestImpl(ClassUnloadRequest base, ShadowMaster master) {
		super(base, master);
	}
