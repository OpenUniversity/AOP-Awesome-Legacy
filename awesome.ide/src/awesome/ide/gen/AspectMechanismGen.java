...
public class AspectMechanismGen
{
  ...
  protected final String TEXT_2 = ";" + NL + "" + NL + "import awesome.platform.*;" + NL + "import java.util.List;" + NL + "import org.aspectj.weaver.bcel.BcelShadow;" + NL + "" + NL + "/**" + NL + " * <p>Every aspect mechanism extends <b>awesome.platform.AwesomeMechanism</b>. By that, your mechanism may reuse the" + NL + " * <b>match</b> and <b>order</b> services of AspectJ. In other words, you may translate" + NL + " * your DSAL program into AspectJ aspects and enjoy its weaving services for free. To allow that," + NL + " * your front-end <b>MUST</b> add to each generated aspect the annotation @AwAspectMechanism(id=\"";
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(id.toLowerCase());
