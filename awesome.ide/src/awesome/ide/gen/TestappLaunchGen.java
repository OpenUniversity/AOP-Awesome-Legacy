...
public class TestappLaunchGen
{
  protected static String nl;
  public static synchronized TestappLaunchGen create(String lineSeparator)
  {
    nl = lineSeparator;
    TestappLaunchGen result = new TestappLaunchGen();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "\"/>" + NL + "</mapAttribute>" + NL + "<stringAttribute key=\"org.eclipse.jdt.launching.MAIN_TYPE\" value=\"org.aspectj.tools.ajc.Main\"/>" + NL + "<stringAttribute key=\"org.eclipse.jdt.launching.PROGRAM_ARGUMENTS\" value=\"-1.5 -outjar ";
  protected final String TEXT_5 = ".jar&#13;&#10;";
  protected final String TEXT_6 = "/aspects/* ";
  protected final String TEXT_7 = "/base/*\"/>" + NL + "<stringAttribute key=\"org.eclipse.jdt.launching.PROJECT_ATTR\" value=\"";
