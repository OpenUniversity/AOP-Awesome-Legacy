...
public class AMTestReadmeGen
{
  ...
  protected final String TEXT_3 = "/" + NL + "\tHere you create your test application that usually consists of a base system (in base/)" + NL + "\tand additional aspects (aspects/). We have created a Main file and an initial aspect" + NL + "\tas a starting point. Note that other aspects you choose to add should have the same" + NL + "\tclass-level annotations. After defining the application, (1) execute weave.launch to" + NL + "\tweave the application (2) refresh, and (3) run execute.launch." + NL + "weaving-info/" + NL + "\tHolds information collected during the weaving of the test application. The info is" + NL + "\tin binary form, and is deserialized by the test case mentioned below." + NL + "src/testapps" + NL + "\tUse the enclosing JUnit test case to verify that the results are as expected.";
